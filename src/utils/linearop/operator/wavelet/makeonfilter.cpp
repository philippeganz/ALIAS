    ...
    case coiflet:
        {
            ...
            case 2:
                {
                    data_size = 12;
                    double data_local[12] = {0.016387336463, -0.041464936782, -0.067372554722, 0.386110066823, 0.81272363545, 0.417005184424, -0.076488599078, -0.059434418646, 0.023680171947, 0.005611434819, -0.001823208871, -0.000720549445};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 3:
                {
                    data_size = 18;
                    double data_local[18] = {-0.003793512864, 0.007782596426, 0.023452696142, -0.065771911281, -0.061123390003, 0.40517690241, 0.793777222626, 0.428483476378, -0.071799821619, -0.082301927106, 0.034555027573, 0.015880544864, -0.009007976137, -0.002574517688, 0.001117518771, 0.00046621696, -0.000070983303, -0.000034599773};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 4:
    ...
    case daubechies:
        {
            ...
            case 6:
                {
                    data_size = 6;
                    double data_local[6] = {0.33267055295, 0.806891509311, 0.459877502118, -0.13501102001, -0.085441273882, 0.035226291882};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 8:
                {
                    data_size = 8;
                    double data_local[8] = {0.230377813309, 0.714846570553, 0.63088076793, -0.027983769417, -0.187034811719, 0.030841381836, 0.032883011667, -0.010597401785};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 10:
                {
                    data_size = 10;
                    double data_local[10] = {0.160102397974, 0.603829269797, 0.724308528438, 0.138428145901, -0.242294887066, -0.032244869585, 0.07757149384, -0.006241490213, -0.012580751999, 0.003335725285};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 12:
                {
                    data_size = 12;
                    double data_local[12] = {0.11154074335, 0.494623890398, 0.751133908021, 0.315250351709, -0.226264693965, -0.129766867567, 0.097501605587, 0.02752286553, -0.031582039317, 0.000553842201, 0.004777257511, -0.001077301085};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 14:
            ...
            case 16:
                {
                    data_size = 16;
                    double data_local[16] = {0.054415842243, 0.312871590914, 0.675630736297, 0.585354683654, -0.015829105256, -0.284015542962, 0.000472484574, 0.12874742662, -0.017369301002, -0.044088253931, 0.013981027917, 0.008746094047, -0.004870352993, -0.000391740373, 0.000675449406, -0.000117476784};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 18:
                {
                    data_size = 18;
                    double data_local[18] = {0.038077947364, 0.243834674613, 0.60482312369, 0.657288078051, 0.133197385825, -0.293273783279, -0.096840783223, 0.148540749338, 0.030725681479, -0.067632829061, 0.000250947115, 0.022361662124, -0.004723204758, -0.004281503682, 0.001847646883, 0.000230385764, -0.000251963189, 0.000039347320};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 20:
    ...
    case symmlet:
        {
            ...
            case 5:
                {
                    data_size = 10;
                    double data_local[10] = {0.038654795955, 0.041746864422, -0.055344186117, 0.281990696854, 1.023052966894, 0.89658164838, 0.023478923136, -0.247951362613, -0.029842499869, 0.027632152958};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 6:
                {
                    data_size = 12;
                    double data_local[12] = {0.021784700327, 0.004936612372, -0.166863215412, -0.068323121587, 0.694457972958, 1.113892783926, 0.477904371333, -0.102724969862, -0.029783751299, 0.06325056266, 0.002499922093, -0.011031867509};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 7:
            ...
            case 8:
                {
                    data_size = 16;
                    double data_local[16] = {0.002672793393, -0.0004283943, -0.021145686528, 0.005386388754, 0.069490465911, -0.038493521263, -0.073462508761, 0.515398670374, 1.099106630537, 0.68074534719, -0.086653615406, -0.202648655286, 0.010758611751, 0.044823623042, -0.000766690896, -0.004783458512};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 9:
                {
                    data_size = 18;
                    double data_local[18] = {0.001512487309, -0.000669141509, -0.014515578553, 0.012528896242, 0.087791251554, -0.02578644593, -0.270893783503, 0.049882830959, 0.873048407349, 1.015259790832, 0.337658923602, -0.077172161097, 0.000825140929, 0.042744433602, -0.016303351226, -0.018769396836, 0.000876502539, 0.001981193736};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 10:
    ...
    case battle:
        {
            ...
            case 1:
                {
                    data_size = 23;
                    double data_local[23] = {-0.0000867523, -0.000158601, 0.000361781, 0.000652922, -0.00155701, -0.00274588, 0.00706442, 0.012003, -0.0367309, -0.0488618, 0.280931, 0.578163, 0.280931, -0.0488618, -0.0367309, 0.012003, 0.00706442, -0.00274588, -0.00155701, 0.000652922, 0.000361781, -0.000158601, -0.000086752300000};
                    std::copy(data_local, data_local+data_size, data);
                    break;
                }
            case 3:
